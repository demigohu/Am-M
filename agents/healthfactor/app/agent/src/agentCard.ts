...
export function buildAgentCard(
  ...
  return {
    name,
    description:
      "Guard: if Venus HF on BSC testnet drops below the variant threshold, repayBorrow or mint inside the session cap. Deliverable includes the rescue tx hash or an honest cap/permission failure — not an alert.",
