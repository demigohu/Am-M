# healthfactor — A2A seller agent (Guard / Venus)

Cara run, wallet, dan env: lihat [`docs/RUNNING.md`](../../docs/RUNNING.md).
Copy [`../.env.example`](../.env.example) → `../.studio/.env.local` (mode 0600).
