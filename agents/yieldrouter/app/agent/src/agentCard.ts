...
export function buildAgentCard(
  ...
  return {
    name,
    description:
      "Yield: park idle tokens in Venus vUSDT/vUSDC/vBNB on BSC testnet and rotate when the testnet APR gap exceeds the variant threshold. Not a cross-protocol router.",
